        ...
        <div className="max-w-3xl mx-auto p-8 md:p-12">
          ...
          {step === 0 && (
            <div className="grid gap-8">
              <Field label="Full Name" error={touched.name && !form.name}>
                ...
                <Help
                  id="name-help"
                  text="Enter your legal name for certificates."
                />
              </Field>

              <Field
                label="Email"
                error={touched.email && !/.+@.+\..+/.test(form.email)}
              >
                <Input
                  type="email"
          ...
          {step === 1 && (
            <div className="grid gap-8">
              <Field
                label="Team Name"
                error={touched.teamName && !form.teamName}
              >
                <Input
              ...
              <Field label="Track" error={touched.track && !form.track}>
                <select
                  className="h-12 rounded-md border bg-background text-base"
                  value={form.track}
            ...
            <div className="grid gap-8">
              ...
              >
                ...
                <span className="text-base">
                  I agree to the hackathon’s code of conduct and data policies.
                </span>
              </label>
            </div>
          )}
          ...
          <div className="mt-10 flex items-center justify-between">
            ...
            {step < 2 ? (
              ...
              <Button
                className="bg-brand text-primary-foreground hover:bg-brand/90"
                onClick={() =>
                  alert(`Thanks ${form.name}! Check your email for next steps.`)
                }
                disabled={!canNext}
                size="lg"
              >
...
function Field({
  ...
  return (
    <div>
      ...
      <div className={cn("mt-2", error ? "animate-shake" : "")}>{children}</div>
      {error && (
